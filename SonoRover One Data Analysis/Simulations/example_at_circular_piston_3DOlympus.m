...
source_diam     = 13e-3;    % piston diameter [m]
source_amp      = 1e6;      % source pressure [Pa]

% grid parameters
axial_size      = 90e-3;    % total grid size in the axial dimension [m]
lateral_size    = 30e-3;    % total grid size in the lateral dimension [m]

% computational parameters
ppw             = 10;        % number of points per wavelength
t_end           = 80e-6;    % total compute time [s] (this must be long enough to reach steady state)
